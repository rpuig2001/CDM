                                        ...
                                        if (bmiMode) {
                                            ...
                                            for (size_t t = 0; t < slotList.size(); t++) {
                                                ...
                                                for (size_t i = 0; i < taxiTimesList.size(); i++) {
                                                    if (listCallsign ==
                                                        taxiTimesList[i].substr(0, taxiTimesList[i].find(","))) {
                                                        if (taxiTimesList[i].substr(taxiTimesList[i].find(",") + 3,
                                                                                    1) == ",") {
                                                            listDepRwy = taxiTimesList[i].substr(
                                                                taxiTimesList[i].find(",") + 1, 2);
                                                            depRwyFound = true;
                                                        } else if (taxiTimesList[i].substr(
                                                                       taxiTimesList[i].find(",") + 4, 1) == ",") {
                                                            listDepRwy = taxiTimesList[i].substr(
                                                                taxiTimesList[i].find(",") + 1, 3);
                                                            depRwyFound = true;
                                                        }
                                                    }
                                                }
                                                ...
                                                for (size_t i = 0; i < planeAiportList.size(); i++) {
                                                    if (listCallsign ==
                                                        planeAiportList[i].substr(0, planeAiportList[i].find(","))) {
                                                        listAirport = planeAiportList[i].substr(
                                                            planeAiportList[i].find(",") + 1, 4);
                                                    }
                                                }
                                                    ...
                                                    if (TTOTFinal == listTTOT && callsign != listCallsign &&
                                                        ...
                                                        if (alreadySetTOStd) {
                                                            ...
                                                            alreadySetTOStd = true;
                                                                ...
                                                                stoi(calculateTime(listTTOT, rateHour))) &&
                                                               (stoi(TTOTFinal) >
                                                                stoi(calculateLessTime(listTTOT, rateHour))) &&
                                                ...
                                                if (correctTTOT && sidIntervalEnabled && callsign != listCallsign) {
                                                    ...
                                                    if (interval > 0) {
                                                        ...
                                                        while (!found) {
                                                            found = true;
                                                            if ((stoi(TTOTFinal) <
                                                                 stoi(calculateTime(listTTOT, interval))) &&
                                                                (stoi(TTOTFinal) >
                                                                 stoi(calculateLessTime(listTTOT, interval)))) {
                                                                found = false;
                                                                if (alreadySetTOStd) {
                                                                    TTOTFinal = calculateTime(TTOTFinal, 0.5);
                                                                    correctTTOT = false;
...
vector<Plane> CDM::backgroundProcess_recaulculate() {
    ...
    try {
        ...
        for (size_t i = 0; i < copySlotList.size(); i++) {
            ...
            if (!aicraftInFinalTimesList && GetDifferenceTimeHHMMSS(copySlotList[i].tsat, timeNow, true) < 6) {
                aicraftInFinalTimesList = true;
            }
