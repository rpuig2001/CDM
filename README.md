...
- taxizones.txt
  ...
  - rate.txt
    - You can set the rate/hour for specific runway to use with the option ``defaultRate option="0"`` in the CDMconfig.xml. You can declare every runway rate with the following format: ``AIRPORT:RUNWAY=RATE``, ex:``LEBL:25L=40`` (Each line has a runway with his rate)
